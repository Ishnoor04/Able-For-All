    ...
    <div>
      <section className='py-24'>
        <div className='mx-auto max-w-7xl px-4 sm:px-6 md:px-8 relative'>
          <div className='grid sm:grid-cols-2 grid-cols-1 gap-x-24'>
            <div className='md:max-w-xl w-full sm:h-[600px] flex items-center justify-center  bg-cover bg-no-repeat  '>
              <div className=''>
                <div className='mb-12 max-w-[570px] lg:mb-0'>
                  <h2 className={`${styles.heading3}`}>Let's Discuss</h2>
                  <p className={`${styles.paragraph2} mb-6`}>
                    Fill out the form, or call us to set up an in-home
                    consultation.
                  </p>
                  {/* <div className='mb-8 flex w-full max-w-[370px]'>
                    ...
                    <div className='w-full'>
                      ...
                      <p className={`${styles.paragraph2}`}>
                        {/* Unit 1, 138 Days Road, Ferryden Park, SA 5010 
                      </p>
                    </div>
                  </div> */}
                  ...
                  <a href='mailto:info@ableforall.com.au'>
                    <div className='mb-8 flex w-full max-w-[370px]'>
                      <div className='mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary/5 text-primary sm:h-[70px] sm:max-w-[70px]'>
                        <svg
                          width='32'
                      ...
                      <div className='w-full'>
                        <h4 className={`${styles.heading4} mb-1`}>
                          Email Address
                        </h4>
                        <p className={`${styles.paragraph2}`}>
            ...
            {/*////////////////////// form ///////////////////////// */}
            <div className='flex items-center md:mb-0 mb-10 relative'>
              <div className=''>
                <form action='' onSubmit={submitHandler}>
                  ...
                  ></textarea>
                  {isPopupOpen && (
                    <div className='popup z-[990] mb-4'>
                  ...
                  <button
                    className={`${styles.paragraph2} w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-[#6d60ab] shadow transition-all duration-700 hover:bg-[#3a335b]`}
                  >
                    Submit
                  </button>
                </form>
