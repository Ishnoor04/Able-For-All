            ...
            <div className='flex items-center md:mb-0 mb-10 relative'>
              <div className=''>
                <form action='' onSubmit={submitHandler}>
                  ...
                  <button className={`${styles.paragraph2} w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-[#6d60ab] shadow transition-all duration-700 hover:bg-[#3a335b]`}>
                    Submit
                  </button>
                </form>
              </div>
